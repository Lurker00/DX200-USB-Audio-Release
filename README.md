...
**1.0.26** - only available in [custom firmware builds](https://github.com/Lurker00/DX200-firmware) starting from 2.2.103:
...
This feature requires either SuperSU installed, or a permission available only for pre-installed applications. This restriction makes no use for a separate distribution.
